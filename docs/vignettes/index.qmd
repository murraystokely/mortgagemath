...
cadence; convenience constructors for common US, Canadian, and
Actual/360 loans; full ARM support (rate changes, optional recast,
optional payment caps with negative amortization).
...
| [Worked examples](examples.qmd) | Picking the right configuration for your loan type | ~10 pages |
